...
import { blockUser, deleteAIProjects, deleteBingProjects, deleteLLMProjects, deleteUser, editAIProjects, editBingProjects, editLLMProjects, getAIModeProjects, getBingProjects, getLLMProjects, getUsers } from "../../services/api";
...
import EditAIMode from "./EditAIMode";
...
const AIProjectList = () => {
  ...
  const fetchProjects = async (filters) => {
    try {
      ...
      const response = await getAIModeProjects(filteredQuery);
  ...
  }, [filters.name, filters.endDate, refresh]);
  ...
  const handleProjectSubmit = async (payload) => {
    try {
      await editAIProjects(editingProject._id, payload);
  ...
  const confirmDelete = async (projectId) => {
    try {
      await deleteAIProjects(projectId);
