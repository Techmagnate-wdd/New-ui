...
// // //------------------------------------------------------------------
// // const EditAIMode = ({ isOpen, onClose, onSubmit, editingProject }) => {
// //     // -------------------------------------------------------------------------------
...
// //         console.log(editingProject,"billu")
...
// //     if (!projectName ||  !frequency || !priority|| competitors.some(c => !c.brand || !c.domain))
// //         {
...
// //     onSubmit(payload);
// //     console.log(payload,"awasthi testing")
// //     onClose()
...
//     // if (!projectName || !target || !frequency || competitors.some(c => !c.brand || !c.domain)) 
//     if (!projectName||  !domainName ||  !frequency || !priority|| competitors.some(c => !c.brand || !c.domain))
//         {
//       setError("Please fill in all required fields.");
//       return;
//     }
