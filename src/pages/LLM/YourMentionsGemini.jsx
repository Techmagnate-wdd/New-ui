...
const YourMentionsGemini = ({
    endpoint = "/api/mentions?period=7d",
    fetchOnMount = true,
    projectId = "68b185ae82ab7b0e3ffa2457",
    model = "llm_gemini",
    data
}) => {
...
export default YourMentionsGemini;
