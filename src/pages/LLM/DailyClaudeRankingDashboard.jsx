...
const ClaudeRankings = () => {
  ...
  const getCurrentPageData = () => {
    ...
    // Flatten if nested
    const flatData = citationsData.flat();
  ...
  const fetchProjects = async () => {
    try {
      let filters = {}
      const res = await getLLMProjects(filters, "claude");
  ...
  const fetchTasks = async (page = 1) => {
    ...
    try {
      ...
      const data = response.data.data.tasks.map((task) => task.raw_results)[0]?.flat()
  ...
  return (
    <div className="project-dashboard container1 py-4">
      ...
      <div className="row row-cols-xxxl-5 row-cols-lg-3 row-cols-sm-2 row-cols-1 gy-4 pt-12">
        ...
        <div className="col">
          ...
          <Tooltip
            id="Prompt Rankings"
            place="top"
            content="This shows prompts rankings of a project"
            delayShow={150}
          />
        </div>
              ...
              <div>
                <p className="small text-muted mb-1 d-flex align-items-center gap-2">
                  ...
                  <span
                    ...
                    tabIndex={0}
                    role="button"
                    aria-label="More info about Total Mentions"
                    style={{ lineHeight: "0" }}
                  >
                    <Icon icon="fa6-solid:circle-question" className="text-muted" />
                  </span>
              ...
              <div>
                <p className="small text-muted mb-1 d-flex align-items-center gap-2">
                  ...
                  <span
                    ...
                    tabIndex={0}
                    role="button"
                    aria-label="More info about Average Rank"
                    style={{ lineHeight: "0" }}
                  >
                    <Icon icon="fa6-solid:circle-question" className="text-muted" />
                  </span>
      ...
      <CompetitorRankings
        ...
        slug="llm_claude" // change if you want other LLMs
