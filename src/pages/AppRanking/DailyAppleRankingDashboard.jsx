...
import {
  ...
  getAppRankKeywords,
  getAppRankProjects,
  getDailyAppRankingReport,
} from "../../services/api";
import AuthContext from "../../context/AuthContext";
import "../../styles/KeywordsRanking.css";

const DailyAppleRankingDashboard = () => {    const [brands, setBrands] = useState([]);
  ...
  const fetchProjects = async () => {
    try {
      const res = await getAppRankProjects("", filter.apiType);
  ...
  const fetchTasks = async (page = 1, activeTabKey) => {
    try {
      ...
      const baseQuery = {
        ...
        ...(filter.apiType && { apiType: filter.apiType }),
      };

      const response = await getDailyAppRankingReport(page, 10, baseQuery);
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            <a
                                              ...
                                              style={{
                                                textDecoration: "none",
                                                // color: "#1a73e8", // Google‑blue style link
                                                color: "#e87e1aff", // Google‑blue style link
                                                fontSize: "14px",
                                                fontWeight: 500,
                                              }}
                                            >
...
export default DailyAppleRankingDashboard;
