...
import { blockUser, deleteAppRankProjects, deleteBingProjects, deleteLLMProjects, deleteUser, editAppRankProjects, editBingProjects, editLLMProjects, getAppRankProjects, getBingProjects, getLLMProjects, getUsers } from "../../services/api";
...
const AppProjectList = () => {
  ...
  const fetchProjects = async (filters) => {
    try {
      ...
      const response = await getAppRankProjects(filteredQuery,"all");
  ...
  const handleProjectSubmit = async (payload) => {
    try {
      await editAppRankProjects(editingProject._id, payload);
  ...
  const confirmDelete = async (projectId) => {
    try {
      await deleteAppRankProjects(projectId);
