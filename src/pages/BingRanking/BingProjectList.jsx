...
import { blockUser, deleteBingProjects, deleteLLMProjects, deleteUser, editBingProjects, editLLMProjects, getBingProjects, getLLMProjects, getUsers } from "../../services/api";
...
const BingProjectList = () => {
  ...
  const fetchProjects = async (filters) => {
    try {
      ...
      const response = await getBingProjects(filteredQuery);
  ...
  const handleProjectSubmit = async (payload) => {
    try {
      await editBingProjects(editingProject._id, payload);
  ...
  const confirmDelete = async (projectId) => {
    try {
      await deleteBingProjects(projectId);
...
export default BingProjectList;
