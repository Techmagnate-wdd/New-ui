...
import { getExcel, getFeaturedSnippetDetails, getProjects, getSerpCategorySubCategorySummaryDashboard, getSerpCategorySummaryDashboard, getSerpSummaryDashboard, getUnifiedRankingDashboard } from "../../services/api";
...
export default function SerpCategorySubcategorySummaryDashboard() {
  // filters + selections
  ...
  const fetchFeaturedStatusesForPage = useCallback(async (selectedProjectId, pageNum, limit, appliedFilters = {}) => {
    ...
    try {
      ...
      const resp = await getSerpCategorySubCategorySummaryDashboard(
