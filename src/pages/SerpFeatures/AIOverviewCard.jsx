...
import { getAIOverview, getAppFeatures, getPAA, getPeopleAlsoAsk } from "../../services/api";
...
const AIOverviewCard = ({ filter, setTotalSV, setTotalKeywords, setSelectedProjectData }) => {
    ...
    const fetchSerpFeatures = useCallback(
        async (currentFilter) => {
            ...
            try {
                const resp = await getAIOverview(query);
        ...
        <div className="mt-4">
            {loading ? (
                ...
                >
                    ...
                    >
                        <h6 style={{ color: "#4a4a4a", margin: 0 }}>AI Overview</h6>
