...
import { getAppFeatures, getImages, getPAA, getPeopleAlsoAsk, getPeopleAlsoAskMetrics, getPeopleAlsoAskMetricsSummary, getTopStories } from "../../services/api";
...
const TopStoriesCard = ({ filter, setTotalSV, setTotalKeywords, setSelectedProjectData }) => {
    ...
    const fetchSerpFeatures = useCallback(
        async (currentFilter) => {
            ...
            try {
                const resp = await getTopStories(query)
        ...
        <div className="mt-4">
            {loading ? (
                ...
                >
                    ...
                    >
                        <h6 style={{ color: "#4a4a4a", margin: 0 }}>Top Stories</h6>
