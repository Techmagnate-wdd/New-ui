...
// import { getAppFeatures, getImages, getPAA, getPeopleAlsoAsk, getPeopleAlsoAskMetrics, getPeopleAlsoAskMetricsSummary, getShortVideos, getTopStories } from "../../services/api";
...
// const ShortVideosCard = ({ filter, setTotalSV, setTotalKeywords }) => {
...
//                 try {
//                     const resp = await getShortVideos(query, {
...
//                         }}
//                     >
//                         <h6 style={{ color: "#4a4a4a", margin: 0 }}>Short Videos</h6>
...
const ShortVideosCard = ({ filter, setTotalSV, setTotalKeywords, setSelectedProjectData }) => {
    const [loading, setLoading] = useState(false);
    const [tableColumns, setTableColumns] = useState([]);
    const [tableData, setTableData] = useState([]);
    const [rawApiResponse, setRawApiResponse] = useState(null);
