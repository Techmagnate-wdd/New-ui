...
import AppFeaturesCard from "./AppPackCard";
    ...
    <div className="project-dashboard container py-4">
      ...
      {loadingExcel ? (
        ...
        <>
          ...
          <FeaturedSnippetCard filter={filter} setTotalSV={setTotalSV} />

          <AppFeaturesCard filter={filter} setOsData={setOsData} />

          <PAACard filter={filter} />

          <AIOverviewCard filter={filter} />
        </>
      )}
    </div>
  );
