...
import { getDiscussionsAndForums, getFeaturedSnippet } from "../../services/api";
...
const DiscussionsAndForumsCard = ({ filter, setTotalSV, setTotalKeywords, setSelectedProjectData }) => {
    ...
    const fetchSerpFeatures = useCallback(
        async (currentFilter, signal) => {
            ...
            try {
                const resp = await getDiscussionsAndForums(query, { signal });
    ...
    const loadDetailsPage = useCallback(
        async (pageNum, pageSize, ctxOverride) => {
            ...
            try {
                ...
                const resp = await getDiscussionsAndForums(query, {
        ...
        <div className="mt-4">
            {loading ? (
                ...
                >
                    ...
                    >
                        <h6 style={{ color: "#4a4a4a", margin: 0 }}>Discussions And Forums</h6>
...
export default DiscussionsAndForumsCard;