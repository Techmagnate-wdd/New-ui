...
import { getDiscussionsAndForums, getFeaturedSnippet, getVideos } from "../../services/api";
...
const VideoCard = ({ filter, setTotalSV, setTotalKeywords, setSelectedProjectData }) => {
    ...
    const fetchSerpFeatures = useCallback(
        async (currentFilter, signal) => {
            ...
            try {
                const resp = await getVideos(query, { signal });
        ...
        <div className="mt-4">
            {loading ? (
                ...
                >
                    ...
                    >
                        <h6 style={{ color: "#4a4a4a", margin: 0 }}>Videos</h6>
