...
// import { getAppFeatures, getImages, getLocalPack, getPAA, getPeopleAlsoAsk, getPeopleAlsoAskMetrics, getPeopleAlsoAskMetricsSummary } from "../../services/api";
...
// const LocalPackCard = ({ filter, setTotalSV, setTotalKeywords }) => {
...
//                 try {
//                     const resp = await getLocalPack(query, {
...
//                     keyword: it.keyword,
//                     url: it.url || null,
//                     local_pack_rank: it.url_rank || null,
//                     cid: it.cid || null,
//                     phone: it.phone || null,
//                     title: it.title || null,
...
//                         }}
//                     >
//                         <h6 style={{ color: "#4a4a4a", margin: 0 }}>Local Pack</h6>
...
const LocalPackCard = ({ filter, setTotalSV, setTotalKeywords, setSelectedProjectData }) => {
    const [loading, setLoading] = useState(false);
    const [tableColumns, setTableColumns] = useState([]);
    const [tableData, setTableData] = useState([]);
    const [rawApiResponse, setRawApiResponse] = useState(null);
