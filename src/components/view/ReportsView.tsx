...
export function ReportsView() {
  ...
  return (
    <div className="space-y-6">
      <Card className="p-6 bg-gradient-to-r from-gray-700 to-gray-900 text-white">
        <h2 className="text-2xl font-bold mb-2">Report Builder</h2>
        <p className="text-gray-300">Create custom reports and export your data</p>
      </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Section Selection */}
          <Card className="p-6">
            <h3 className="font-semibold text-gray-900 mb-4">Select Report Sections</h3>
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <div className="bg-gray-100 rounded-lg p-8 mb-4 min-h-[300px] flex items-center justify-center">
